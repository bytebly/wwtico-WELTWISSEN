...
export const FLEET_CATEGORIES: FleetCategory[] = [
  {
    ...
    description: "Standard and long-reach excavators for earthmoving, trenching, mass excavation and site development. Available in multiple tonnage classes.",
    isFeatured: true,
  ...
  },
  {
    ...
    category: "Heavy Machinery",
    badgeTag: "Heavy Machinery",
    description: "Rigid and articulated dump trucks for bulk earthmoving, aggregate transport and quarry operations.",
  ...
  },
  {
    ...
    badgeTag: "LIFTING",
    description: "All-terrain, rough-terrain and crawler cranes for heavy lifting, steel erection and plant maintenance.",
  ...
  },
  {
    ...
    category: "Heavy Machinery",
    badgeTag: "Heavy Machinery",
    description: "Heavy bulldozers and track loaders for bulk earthworks, site clearing, ripping and material movement across tough terrain.",
  ...
  },
  {
    ...
    category: "Heavy Machinery",
    badgeTag: "Heavy Machinery",
    description: "Versatile wheel backhoe loaders with front loader and rear digging arm for urban infrastructure, trenching and utility installation.",
  ...
  },
  {
    ...
    category: "Heavy Machinery",
    badgeTag: "Heavy Machinery",
    description: "High-capacity wheel loaders for aggregate handling, stockpiling, truck loading and batching plant supply.",
  ...
  },
  {
    ...
    category: "Heavy Machinery",
    badgeTag: "Heavy Machinery",
    description: "Motor graders and vibratory soil and asphalt compactors for road construction, subgrade leveling and surface finishing.",
  ...
  },
  {
    ...
    badgeTag: "TRANSPORT",
    description: "Heavy lowbed trailers, extendable trailers and flatbeds for equipment mobilization, steel transport and oversized cargo delivery.",
  ...
  },
  {
    ...
    badgeTag: "TRANSPORT",
    description: "Water tankers for site dust suppression, soil compaction and potable water delivery across active project sites.",
  ...
  },
  {
    ...
    category: "Lifting & Access",
    badgeTag: "ACCESS",
    description: "Electric and diesel articulated boom lifts, telescopic manlifts and scissor lifts for safe working at height.",
  ...
  },
  {
    ...
    description: "Telescopic handlers and rough-terrain diesel forklifts for material offloading, yard staging and high-reach placement.",
