      ...
      <section className="flex flex-col w-full px-5 pt-8 pb-10 sm:px-10 sm:pt-[24px] sm:pb-[48px] lg:px-20 lg:pt-[40px] lg:pb-[80px]">
        <div className="mx-auto flex w-full max-w-[1280px] flex-col">
          {DISCIPLINES.map((discipline, index) => {
            ...
            return (
              <div key={discipline.id} id={discipline.id} className="w-full">
                ...
                <div
                  className={`flex lg:hidden flex-col gap-6 pb-10 w-full ${
                    index !== DISCIPLINES.length - 1 ? 'border-b border-[#D1C9B7]' : ''
                  }`}
                >
                  {/* Label */}
